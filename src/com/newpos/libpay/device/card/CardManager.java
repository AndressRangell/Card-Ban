...
public class CardManager {
    ...
    static String clase = "CardManager.java";
            ...
            new Thread() {
                ...
                public void run() {
                    try {
                                    ...
                                    if (!isEnd) {
                                        ...
                                        if (0 == i) {
                                            ...
                                            if (2 == i)
                                                ...
                                                info.setErrno(Tcode.T_search_card_err_mag);
                                            listener.callback(info);
                                        }
                                    }
                                }
                        ...
                        Logger.logLine(LogType.EXCEPTION, clase, sdk.getMessage());
                        Logger.logLine(LogType.EXCEPTION, clase, sdk.getStackTrace());
