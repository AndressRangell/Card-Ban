...
public class TMConfig implements Serializable {
    ...
    public TMConfig setTimeoutData(int timeoutData) {
    ...
    /**
     * Se imprime como numero de lote
     */
    private int BatchNo;

    public String getBatchNo() {
        return ISOUtil.padleft(BatchNo + "", 4, '0');
    }

    public TMConfig setBatchNo(int batchNo) {
        BatchNo = batchNo;
        if (this.BatchNo == 9999) {
            this.BatchNo = 0;
        }
        this.BatchNo += 1;
        return mInstance;
    ...
    public TMConfig setBatchNoEdit(int batchNo) {
        BatchNo = batchNo;
    ...
    public TMConfig setNroCargo(String nroCargo) {
        this.nroCargo = nroCargo;
        return mInstance;
    }

    public String getMontoMaximoVuelto() {
        return montoMaximoVuelto;
    }

    public TMConfig setMontoMaximoVuelto(String montoMaximoVuelto) {
        this.montoMaximoVuelto = montoMaximoVuelto;
        return mInstance;
    }

    private String montoMaximoVuelto;
    /*-----------------------------------------------------------*/
    private TMConfig() {
        try {
            ...
            Logger.logLine(LogType.EXCEPTION, "TMConfig.java", pse.getMessage());
            Logger.logLine(LogType.EXCEPTION, "TMConfig.java", pse.getStackTrace());
    ...
    public static TMConfig getInstance() {
        ...
        if (mInstance == null) {
            try {
                ...
                Logger.logLine(LogType.EXCEPTION, "TMConfig.java", e.getMessage());
                Logger.logLine(LogType.EXCEPTION, "TMConfig.java", e.getStackTrace());
                    ...
                    try {
                        switch (index - 1) {
                            ...
                            case 18:
                                ...
                                break;
                            case 19:
                                isInit = PolarisUtil.isInitPolaris(context);
                                if (isInit){
                                    if (tablaDevice == null){
                                        tablaDevice = tablaDevice.getSingletonInstance(context);
                                    }
                                    if(tablaDevice.selectT_conf(context)) {
                            ...
                            case 54:
                                ...
                                break;
                            case 55:
                                setTimeoutData(Integer.parseInt(prop) * 1000);
                                break;
                            case 56:
                                setNroCargo(prop);
                                break;
    ...
    public TMConfig incNroCargo() {
        if (this.nroCargo.equals("9999999999")) {
            this.nroCargo = "0000000001";
        }
        long boletaActual = Long.parseLong(nroCargo) + 1;
        this.nroCargo = "" + boletaActual;
        this.save();
        return mInstance;
    }
