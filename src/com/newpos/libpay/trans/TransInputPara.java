...
public class TransInputPara {
    ...
    private int isNeedOtherAmount = DefinesBANCARD.DATO_NO_REQUERIDO;
    ...
    public int isNeedOtherAmount() {
        return isNeedOtherAmount;
    }

    public void setNeedOtherAmount(int needOtherAmount) {
        isNeedOtherAmount = needOtherAmount;
    }
